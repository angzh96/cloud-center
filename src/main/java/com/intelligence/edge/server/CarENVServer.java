...
public class CarENVServer {
    ...
    public CarENVServer(String deviceID, int port) throws SocketException {
    ...
    class Task implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                log.info(deviceID+" 环境数据接收端打开：");
                while (runFlag) {
                    socket.receive(packet);
                    log.info(deviceID + " 收到：");
                    String strReceive =
